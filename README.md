...
- Kunal Booch, @Sant268 (Electron, Serverless Components)
...
- Dan Burbach, @DanBurbach (Web Developer/Project Manager)
...
- Larson Carter, @larson-carter (OhMyZsh)
...
- Brenno Fagundes da Silva, @dev-whiteflag (Java Developer and DevOps Engineer @ Atsuki & hrzn)
...
- Brandon Sánchez, @TWB0109 (Latin American Linux And Open Source Enthusiast)
